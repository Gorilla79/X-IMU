...
filePath = 'D:\20192230 이동섭\IMU sensor\test\time, accl, gyro, magn, angl, vel, pos.csv'; % Update with the actual file path
...
gyr = [data.Gyro_X, data.Gyro_Y, data.Gyro_Z]; % gyroscope
acc = [data.Accl_X, data.Accl_Y, data.Accl_Z]; % accelerometer
